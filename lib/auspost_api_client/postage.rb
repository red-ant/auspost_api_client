    ...
    class Parcel
      ...
      class International
        ...
        def calculate(country_code, weight, service_code, option_code=nil, suboption_code=nil, extra_cover=nil)
          ...
          calc_url = "#{API_URL}/postage/parcel/international/calculate.json?#{query}"
          response = @client.http.request_get(calc_url, @client.headers)
      ...
      class Domestic
        ...
        def calculate(from_postcode, to_postcode, length, width, height, weight, service_code, option_code=nil, suboption_code=nil, extra_cover=nil)
          ...
          calc_url = "#{API_URL}/postage/parcel/domestic/calculate.json?#{query}"
          response = @client.http.request_get(calc_url, @client.headers)
          AuspostApiClient::Models::PostageResult.from_hash JSON.parse(response.body, symbolize_names: true)
        end
      end
